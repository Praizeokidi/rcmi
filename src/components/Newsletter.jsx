const Newsletter = () => {
  return (
    <div className="m-auto bg-[url('/images/pexels-nappy-3360204.jpg')] bg-center bg-cover bg-no-repeat    overflow-x-hidden ">
      <div class="relative    m-auto  overflow-hidden   py-16 sm:py-24 lg:py-32 backdrop-brightness-50">
        <div class="mx-auto  isolate max-w-6xl px-6 lg:px-8">
          <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
            ...
            <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
              <div class="flex flex-col items-start">
                ...
                <dt class="mt-4 text-base font-semibold text-white">
                  Weekly articles
                </dt>
                <dd class="mt-2 text-base/7 text-white">
              ...
              <div class="flex flex-col items-start">
                ...
                <dd class="mt-2 text-base/7 text-white">No spam content</dd>
              </div>
            </dl>
          </div>
        </div>
