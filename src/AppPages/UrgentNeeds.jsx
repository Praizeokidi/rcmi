  ...
  return (
    <div>
      ...
      >
        ...
        {/* CONTENT CONTAINER */}
        <div
          className="bg-center bg-cover bg-no-repeat relative overflow-hidden"
          style={{ backgroundImage: `url(${HeaderImg})` }}
        >
          <div className="p-5 m-5 max-w-5xl lg:p-10 py-8 sm:m-9 md:m-16 rounded-xl lg:gap-2 mb-12 lg:mx-auto mt-20 bg-blue-200 grid gap-10 md:grid-cols-2 items-center shadow-2xl">
            ...
            <div className="grid p-2 space-y-7">
              ...
              <p className="lg:max-w-xs">
                ...
                unimaginable challenges. Whether it&apos;s ministering to those
                with leprosy, sharing the Gospel, or responding to crisis,
                your support matters. Choose from several urgent needs below
                and donate today.
              </p>

              <Link
                to="/donations"
                className="buttn text-white text-center bg-green-500 hover:bg-green-600 hover:text-black transition p-4 max-w-72 rounded"
              >
